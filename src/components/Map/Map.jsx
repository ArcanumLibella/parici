...
const Map = ({ onDistrictClick, minAndMax, min, max }) => {
  ...
  return (
    <div className='map'>
      <h2 className='map__title'>Change <span className='highlight'>district</span> if you like</h2>
      ...
      <div className="scale">
        <h3 className='scale__title'>Estimated travel time</h3>
        <div className='scale__wrapper'>
          <p className="scale__value">{min} mins</p>
          <div className="scale__legend"></div>
